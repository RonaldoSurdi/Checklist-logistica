object HWS_Form_Usuario_Sistema_Inclusao: THWS_Form_Usuario_Sistema_Inclusao
  Left = 0
  Top = 0
  ActiveControl = HWS_Edit_Nome
  BorderStyle = bsDialog
  Caption = 'Inclus'#227'o de Usu'#225'rios do Sistema'
  ClientHeight = 346
  ClientWidth = 794
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object GroupBox2: TGroupBox
      ...
      object HWS_CheckBox_AlterarSenha: TCheckBox
        ...
        Width = 321
        Height = 20
        Caption = 'Alterar a senha no pr'#243'ximo logon no sistema'
        TabOrder = 3
      end
    end
  end
