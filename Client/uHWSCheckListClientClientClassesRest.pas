...
unit uHWSCheckListClientClientClassesRest;
...
type
  ...
  private
    ...
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand: TDSRestCommand;
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache: TDSRestCommand;
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand: TDSRestCommand;
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache: TDSRestCommand;
    FF_HWS_RecebeImagensCommand: TDSRestCommand;
    FF_HWS_RecebeImagensCommand_Cache: TDSRestCommand;
  public
    ...
    function F_HWS_RetornaChkExp(HWS_CodEmpresa: string; HWS_tipoIni: string; HWS_tipoEnd: string; const ARequestFilter: string = ''): TDBXReader;
    function F_HWS_RetornaChkExp_Cache(HWS_CodEmpresa: string; HWS_tipoIni: string; HWS_tipoEnd: string; const ARequestFilter: string = ''): IDSRestCachedDBXReader;
    ...
    function F_HWS_InserirVeiculosNaInclusaoDoChip(HWS_Chip: string; HWS_CodCliente: string; const ARequestFilter: string = ''): TJSONArray;
    function F_HWS_InserirVeiculosNaInclusaoDoChip_Cache(HWS_Chip: string; HWS_CodCliente: string; const ARequestFilter: string = ''): IDSRestCachedJSONArray;
    function F_HWS_ImpressaoCheckListsAnalitico_Detalhe(HWS_CodEmpresa: string; HWS_CheckList: string; HWS_DaData: string; HWS_AteData: string; HWS_DaPlaca: string; HWS_AtePlaca: string; HWS_DoStatus: string; HWS_AteStatus: string; const ARequestFilter: string = ''): TDBXReader;
    function F_HWS_ImpressaoCheckListsAnalitico_Detalhe_Cache(HWS_CodEmpresa: string; HWS_CheckList: string; HWS_DaData: string; HWS_AteData: string; HWS_DaPlaca: string; HWS_AtePlaca: string; HWS_DoStatus: string; HWS_AteStatus: string; const ARequestFilter: string = ''): IDSRestCachedDBXReader;
    function F_HWS_RecebeImagens(HWS_Imagem: TStream; const ARequestFilter: string = ''): TJSONArray;
    function F_HWS_RecebeImagens_Cache(HWS_Imagem: TStream; const ARequestFilter: string = ''): IDSRestCachedJSONArray;
  end;
...
const
  ...
  THWS_ServerMethods_F_HWS_RetornaChkExp: array [0..3] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_CodEmpresa'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_tipoIni'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_tipoEnd'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: ''; Direction: 4; DBXType: 23; TypeName: 'TDBXReader')
  );

  THWS_ServerMethods_F_HWS_RetornaChkExp_Cache: array [0..3] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_CodEmpresa'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_tipoIni'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_tipoEnd'; Direction: 1; DBXType: 26; TypeName: 'string'),
  ...
  THWS_ServerMethods_F_HWS_InserirVeiculosNaInclusaoDoChip: array [0..2] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_Chip'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_CodCliente'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: ''; Direction: 4; DBXType: 37; TypeName: 'TJSONArray')
  ...
  THWS_ServerMethods_F_HWS_InserirVeiculosNaInclusaoDoChip_Cache: array [0..2] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_Chip'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_CodCliente'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: ''; Direction: 4; DBXType: 26; TypeName: 'String')
  ...
  THWS_ServerMethods_F_HWS_ImpressaoCheckListsAnalitico_Detalhe: array [0..8] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_CodEmpresa'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_CheckList'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_DaData'; Direction: 1; DBXType: 26; TypeName: 'string'),
  ...
  THWS_ServerMethods_F_HWS_ImpressaoCheckListsAnalitico_Detalhe_Cache: array [0..8] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_CodEmpresa'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_CheckList'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'HWS_DaData'; Direction: 1; DBXType: 26; TypeName: 'string'),
  ...
  THWS_ServerMethods_F_HWS_RecebeImagens: array [0..1] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_Imagem'; Direction: 1; DBXType: 33; TypeName: 'TStream'),
    (Name: ''; Direction: 4; DBXType: 37; TypeName: 'TJSONArray')
  );

  THWS_ServerMethods_F_HWS_RecebeImagens_Cache: array [0..1] of TDSRestParameterMetaData =
  (
    (Name: 'HWS_Imagem'; Direction: 1; DBXType: 33; TypeName: 'TStream'),
    (Name: ''; Direction: 4; DBXType: 26; TypeName: 'String')
  );
...
function THWS_ServerMethodsClient.F_HWS_RetornaChkExp(HWS_CodEmpresa: string; HWS_tipoIni: string; HWS_tipoEnd: string; const ARequestFilter: string): TDBXReader;
begin
  ...
  FF_HWS_RetornaChkExpCommand.Parameters[0].Value.SetWideString(HWS_CodEmpresa);
  FF_HWS_RetornaChkExpCommand.Parameters[1].Value.SetWideString(HWS_tipoIni);
  FF_HWS_RetornaChkExpCommand.Parameters[2].Value.SetWideString(HWS_tipoEnd);
  FF_HWS_RetornaChkExpCommand.Execute(ARequestFilter);
  Result := FF_HWS_RetornaChkExpCommand.Parameters[3].Value.GetDBXReader(FInstanceOwner);
end;

function THWS_ServerMethodsClient.F_HWS_RetornaChkExp_Cache(HWS_CodEmpresa: string; HWS_tipoIni: string; HWS_tipoEnd: string; const ARequestFilter: string): IDSRestCachedDBXReader;
begin
  ...
  FF_HWS_RetornaChkExpCommand_Cache.Parameters[0].Value.SetWideString(HWS_CodEmpresa);
  FF_HWS_RetornaChkExpCommand_Cache.Parameters[1].Value.SetWideString(HWS_tipoIni);
  FF_HWS_RetornaChkExpCommand_Cache.Parameters[2].Value.SetWideString(HWS_tipoEnd);
  FF_HWS_RetornaChkExpCommand_Cache.ExecuteCache(ARequestFilter);
  Result := TDSRestCachedDBXReader.Create(FF_HWS_RetornaChkExpCommand_Cache.Parameters[3].Value.GetString);
end;
...
function THWS_ServerMethodsClient.F_HWS_InserirVeiculosNaInclusaoDoChip(HWS_Chip: string; HWS_CodCliente: string; const ARequestFilter: string): TJSONArray;
begin
  if FF_HWS_InserirVeiculosNaInclusaoDoChipCommand = nil then
  begin
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand := FConnection.CreateCommand;
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.RequestType := 'GET';
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Text := 'THWS_ServerMethods.F_HWS_InserirVeiculosNaInclusaoDoChip';
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Prepare(THWS_ServerMethods_F_HWS_InserirVeiculosNaInclusaoDoChip);
  end;
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Parameters[0].Value.SetWideString(HWS_Chip);
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Parameters[1].Value.SetWideString(HWS_CodCliente);
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Execute(ARequestFilter);
  Result := TJSONArray(FF_HWS_InserirVeiculosNaInclusaoDoChipCommand.Parameters[2].Value.GetJSONValue(FInstanceOwner));
end;

function THWS_ServerMethodsClient.F_HWS_InserirVeiculosNaInclusaoDoChip_Cache(HWS_Chip: string; HWS_CodCliente: string; const ARequestFilter: string): IDSRestCachedJSONArray;
begin
  if FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache = nil then
  begin
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache := FConnection.CreateCommand;
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.RequestType := 'GET';
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.Text := 'THWS_ServerMethods.F_HWS_InserirVeiculosNaInclusaoDoChip';
    FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.Prepare(THWS_ServerMethods_F_HWS_InserirVeiculosNaInclusaoDoChip_Cache);
  end;
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.Parameters[0].Value.SetWideString(HWS_Chip);
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.Parameters[1].Value.SetWideString(HWS_CodCliente);
  FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.ExecuteCache(ARequestFilter);
  Result := TDSRestCachedJSONArray.Create(FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache.Parameters[2].Value.GetString);
end;

function THWS_ServerMethodsClient.F_HWS_ImpressaoCheckListsAnalitico_Detalhe(HWS_CodEmpresa: string; HWS_CheckList: string; HWS_DaData: string; HWS_AteData: string; HWS_DaPlaca: string; HWS_AtePlaca: string; HWS_DoStatus: string; HWS_AteStatus: string; const ARequestFilter: string): TDBXReader;
begin
  if FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand = nil then
  begin
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand := FConnection.CreateCommand;
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.RequestType := 'GET';
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Text := 'THWS_ServerMethods.F_HWS_ImpressaoCheckListsAnalitico_Detalhe';
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Prepare(THWS_ServerMethods_F_HWS_ImpressaoCheckListsAnalitico_Detalhe);
  end;
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[0].Value.SetWideString(HWS_CodEmpresa);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[1].Value.SetWideString(HWS_CheckList);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[2].Value.SetWideString(HWS_DaData);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[3].Value.SetWideString(HWS_AteData);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[4].Value.SetWideString(HWS_DaPlaca);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[5].Value.SetWideString(HWS_AtePlaca);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[6].Value.SetWideString(HWS_DoStatus);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[7].Value.SetWideString(HWS_AteStatus);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Execute(ARequestFilter);
  Result := FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand.Parameters[8].Value.GetDBXReader(FInstanceOwner);
end;

function THWS_ServerMethodsClient.F_HWS_ImpressaoCheckListsAnalitico_Detalhe_Cache(HWS_CodEmpresa: string; HWS_CheckList: string; HWS_DaData: string; HWS_AteData: string; HWS_DaPlaca: string; HWS_AtePlaca: string; HWS_DoStatus: string; HWS_AteStatus: string; const ARequestFilter: string): IDSRestCachedDBXReader;
begin
  if FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache = nil then
  begin
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache := FConnection.CreateCommand;
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.RequestType := 'GET';
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Text := 'THWS_ServerMethods.F_HWS_ImpressaoCheckListsAnalitico_Detalhe';
    FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Prepare(THWS_ServerMethods_F_HWS_ImpressaoCheckListsAnalitico_Detalhe_Cache);
  end;
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[0].Value.SetWideString(HWS_CodEmpresa);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[1].Value.SetWideString(HWS_CheckList);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[2].Value.SetWideString(HWS_DaData);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[3].Value.SetWideString(HWS_AteData);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[4].Value.SetWideString(HWS_DaPlaca);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[5].Value.SetWideString(HWS_AtePlaca);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[6].Value.SetWideString(HWS_DoStatus);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[7].Value.SetWideString(HWS_AteStatus);
  FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.ExecuteCache(ARequestFilter);
  Result := TDSRestCachedDBXReader.Create(FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache.Parameters[8].Value.GetString);
end;

function THWS_ServerMethodsClient.F_HWS_RecebeImagens(HWS_Imagem: TStream; const ARequestFilter: string): TJSONArray;
begin
  if FF_HWS_RecebeImagensCommand = nil then
  begin
    FF_HWS_RecebeImagensCommand := FConnection.CreateCommand;
    FF_HWS_RecebeImagensCommand.RequestType := 'POST';
    FF_HWS_RecebeImagensCommand.Text := 'THWS_ServerMethods."F_HWS_RecebeImagens"';
    FF_HWS_RecebeImagensCommand.Prepare(THWS_ServerMethods_F_HWS_RecebeImagens);
  end;
  FF_HWS_RecebeImagensCommand.Parameters[0].Value.SetStream(HWS_Imagem, FInstanceOwner);
  FF_HWS_RecebeImagensCommand.Execute(ARequestFilter);
  Result := TJSONArray(FF_HWS_RecebeImagensCommand.Parameters[1].Value.GetJSONValue(FInstanceOwner));
end;

function THWS_ServerMethodsClient.F_HWS_RecebeImagens_Cache(HWS_Imagem: TStream; const ARequestFilter: string): IDSRestCachedJSONArray;
begin
  if FF_HWS_RecebeImagensCommand_Cache = nil then
  begin
    FF_HWS_RecebeImagensCommand_Cache := FConnection.CreateCommand;
    FF_HWS_RecebeImagensCommand_Cache.RequestType := 'POST';
    FF_HWS_RecebeImagensCommand_Cache.Text := 'THWS_ServerMethods."F_HWS_RecebeImagens"';
    FF_HWS_RecebeImagensCommand_Cache.Prepare(THWS_ServerMethods_F_HWS_RecebeImagens_Cache);
  end;
  FF_HWS_RecebeImagensCommand_Cache.Parameters[0].Value.SetStream(HWS_Imagem, FInstanceOwner);
  FF_HWS_RecebeImagensCommand_Cache.ExecuteCache(ARequestFilter);
  Result := TDSRestCachedJSONArray.Create(FF_HWS_RecebeImagensCommand_Cache.Parameters[1].Value.GetString);
end;
...
begin
  ...
  FreeAndNil(FF_HWS_InserirVeiculosNaInclusaoDoChipCommand);
  FreeAndNil(FF_HWS_InserirVeiculosNaInclusaoDoChipCommand_Cache);
  FreeAndNil(FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand);
  FreeAndNil(FF_HWS_ImpressaoCheckListsAnalitico_DetalheCommand_Cache);
  FreeAndNil(FF_HWS_RecebeImagensCommand);
  FreeAndNil(FF_HWS_RecebeImagensCommand_Cache);
  inherited;
end;
